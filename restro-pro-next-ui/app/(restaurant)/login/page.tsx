...
export default function StaffLoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-neutral-950 text-neutral-50 px-4 relative overflow-hidden">
      <div className="login-glow" />
      <div className="login-branding text-center relative z-10 mb-7">
        <div className="login-mark">R</div>
        <h1 className="font-display text-3xl font-semibold">Restro Pro</h1>
        <p className="text-neutral-500 text-sm mt-1">Run your restaurant. Smarter.</p>
      </div>
      <div className="w-full max-w-sm rounded-xl border border-neutral-800 bg-neutral-900 p-7 space-y-4 relative z-10">

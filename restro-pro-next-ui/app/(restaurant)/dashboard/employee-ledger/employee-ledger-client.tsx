    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-50 p-6 md:p-8 max-w-3xl mx-auto">
      ...
      <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-5 mb-6">
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <select value={employeeId} onChange={(e) => setEmployeeId(e.target.value)} className="rounded-md bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm">
          ...
          <select value={type} onChange={(e) => setType(e.target.value)} className="rounded-md bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm">
          ...
          <tbody>
            {entries.map((e) => (
              <tr key={e.id} className="border-t border-neutral-800">
                ...
                <td className="p-3 text-neutral-400 capitalize">{e.type}</td>
